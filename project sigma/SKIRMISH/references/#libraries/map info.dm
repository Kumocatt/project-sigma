...
proc
	...
	map_width()
		if(world.maxx != __maxx)
			__maxx = world.maxx
			__map_width = world.maxx * _tile_width()
		return __map_width
	...
	map_height()
		if(world.maxy != __maxy)
			__maxy = world.maxy
			__map_height = world.maxy * _tile_height()
		return __map_height
...
client
	...
	proc/__ViewChanged()
		...
		__view_widthpx = __view_width * _tile_width()
		__view_heightpx = __view_height * _tile_height()
